...
void intro(){
    ...
    if(cin>> rules && rules == "yes"){
        ...
        cout<< "3. After the character is chosen each player can pick an advisor to help prevent issues from random events"<<endl;
        cout<< "4. Players will take turns answering questions."<< endl;
        cout<< "5. If the answer is correct, the player can roll the die and move forward."<< endl;
        cout<< "6. Landing on certain tiles may have special effects."<< endl;
        ...
        cout<< "        -Pink Tiles: You will get a DNA matching mini game."<< endl;
...
int playTurn(){
    ...
    if(guess == riddle.getAnswer()){
        ...
        cout<<"The correct answer is "<< riddle.getAnswer()<<endl;
        roll = -1;
